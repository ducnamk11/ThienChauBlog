        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <router-link to="/category-list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></router-link>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
...
<script>
    ...
    export default {
        name: "AdminHome",
         components: { VueClock },
         mounted() {
             this.$store.dispatch('countcategory')
             this.$store.dispatch('countpost')
             this.$store.dispatch('countcomment')
             this.$store.dispatch('countuser')
         },
         computed:{
             countCategory(){
              return this.$store.getters.countCategory
             },
             countPost(){
              return this.$store.getters.countPost
             },
             countComment(){
              return this.$store.getters.countComment
             },
             countUser(){
